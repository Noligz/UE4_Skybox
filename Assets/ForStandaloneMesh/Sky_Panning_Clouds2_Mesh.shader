Shader "Skybox/Sky_Panning_Clouds2_Mesh"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                float2 uv0 = i.uvPack.xy;
                float2 uv1 = i.uvPack.zw;
                ...
                fixed cloud1 = tex2D(_CloudTex, float2(speedFactor * 0.001, 0) + uv0).r;
                fixed main = tex2D(_MainTex, float2(speedFactor * 0.0002, 0) + uv0).r;
                fixed cloud2 = tex2D(_CloudTex, uv0 * _CloudTex_ST.xy + 0.5).r;
                ...
                //SkyColors
                fixed3 star = tex2D(_StarTex, uv1 * _StarTex_ST.xy);
